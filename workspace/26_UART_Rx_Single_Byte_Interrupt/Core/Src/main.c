...
/**
 * @brief Initializes and enables the UART Rx interrupt.
 * @param None.
 * @return None.
 */
void vStartUartRxInterrupt(void)
...
{
	/* Do not wake up higher priority task upon the ISR exit. */
	portBASE_TYPE xHigherPriorityTaskWoken = pdFALSE;

	if (USART2->SR & (1U << 5))
	{
		uint8_t temp = (uint8_t)USART2->DR;
