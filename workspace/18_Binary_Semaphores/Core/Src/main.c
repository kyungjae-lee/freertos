 ...
 *
 * @file	main.c
 * @brief	Demonstrates how to work with binary semaphores in a FreeRTOS
 * 			application.
 * @author	Kyungjae Lee
 * @date	Aug 19, 2025
 * @note   	This application creates three tasks that attempt to access a single
 *         	serial port. Observe the behavioral differences between controlled
 *         	access using binary semaphores and uncontrolled access without them.
 *
 *         	Include "semphr.h" to use binary semaphores.
 *
 ******************************************************************************/
...
int main(void)
{
	...
	/* Someone has to give the binary semaphore to get the ball rolling. No one
	 * can take one if none has been given yet. */
...
/**
 * @brief Task function that controls the red LED by synchronizing access with a
 * binary semaphore.
...
/**
 * @brief Task function that controls the orange LED by synchronizing access
...
/**
 * @brief Task function that controls the blue LED by synchronizing access with
 * a binary semaphore.
 * @param pvParameters Pointer to a DataType_t structure containing the sensor
 * data to be sent. This should be passed in a task parameter during task
 * creation.
